import { Avatar, Box, Card, CardContent, Divider, List, ListItem, ListItemAvatar, ListItemButton, ListItemText, TextField, Typography } from '@mui/material'
import React, { useState } from 'react'
import SearchSection from './SearchSection';

const SearchUserListSection = () => {
    ...
    return (
        <Card>
            <CardContent>
                <SearchSection title={"Search More People"} />
